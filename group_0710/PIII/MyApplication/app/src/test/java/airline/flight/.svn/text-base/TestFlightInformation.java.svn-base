...
public class TestFlightInformation {
	 ...
	 */
	private static LocalDateTime early = new LocalDateTime(2015, 1, 5, 1, 6);

	/**
	 * A constant later time than the 'early' field.
	 */
	private static LocalDateTime later = new LocalDateTime(2015, 1, 5, 2, 7);
	...
	public void testWithinDepartureTime() {
		LocalDateTime early = new LocalDateTime(2015, 1, 5, 12, 6);
		LocalDateTime after = new LocalDateTime(2015, 1, 5, 12, 7);
		LocalDateTime arrive = new LocalDateTime(2015, 1, 5, 11, 6);
		LocalDateTime tooEarly = new LocalDateTime(2015, 1, 5, 6, 5);
