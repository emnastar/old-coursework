...
public class SampleTest {
  ...
  public void testGetClient() throws Exception {
    ...
    assertFalse("getClient(String) didn't find any clients.", found.length() <= 0);
  ...
  public void testGetFlights() throws Exception {
    ...
    assertFalse("getFlights(String, String, String) didn't find any flights.", found.length() <= 0);
    assertEquals(msg, expected, found);
  }
  ...
  public void testGetItineraries() throws Exception {
    ...
    assertFalse("getIntineraries(String, String, String) didn't find any flights.", found.length() <= 0);
