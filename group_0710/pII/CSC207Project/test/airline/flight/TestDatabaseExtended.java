...
public class TestDatabaseExtended {
	...
	public void testFlightSorting() throws IOException {
		...
		// Get the data.
		for (Itinerary li : db.searchItineriariesByCost("Toronto", "Venice", "2015-06-15")) {
			actual += li.toStringCostTimeNewline() + "\n\n";
		}
		actual += "\n";
		for (Itinerary li : db.searchItineriariesByTime("Toronto", "Venice", "2015-06-15")) {
			actual += li.toStringCostTimeNewline() + "\n\n";
		}
